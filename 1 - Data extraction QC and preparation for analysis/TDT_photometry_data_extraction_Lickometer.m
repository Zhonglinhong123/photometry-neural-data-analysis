...
subject_IDs = {'FP25'; 'FP41'; 'FP42'};                                                                       
nSubjects = numel(subject_IDs);

% Specify raw data import file names
indiv_raw_datafiles = {'FP25_lickometer_030217'; 'FP41_lickometer_030217';'FP42_lickometer_030217'};   

% Specify export filenames for individual signal QC graphs
indiv_signal_QC_graphs = {'FP25_lickometer_030217_signal'; 'FP41_lickometer_030217'; 'FP42_lickometer_030217'};

% Specify export file name for z-score normalized group photometry 
export_datafile_name = 'Lickometer_group_raw_data.mat';

% Point to folder where data is
data_import_folder = '/Volumes/Fake Server 2/Fiber photometry/Photometry data (all)/FP21-42 Photometry Data Feb-March 2017'; 
...
TDT_data_sources = {'LMag' 'Din0'};   % Specify additional TTL inputs (digital inputs, Din0...DinX) as needed - 3 places to modify code below if more inputs are added                                  
